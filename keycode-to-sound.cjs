...
const keyDefinitions = [
  ...
  { keycodes: [96, 82, 90], key: 'Num 0', sound: '%.58' },
  { keycodes: [97, 83, 87], key: 'Num 1', sound: '%.60' },
  { keycodes: [98, 84, 88], key: 'Num 2', sound: '%.62' },
  { keycodes: [99, 85, 89], key: 'Num 3', sound: '%.63' },
  { keycodes: [100, 86, 83], key: 'Num 4', sound: '%.65' },
  { keycodes: [101, 87, 84], key: 'Num 5', sound: '%.67' },
  { keycodes: [102, 88, 85], key: 'Num 6', sound: '%.68' },
  { keycodes: [103, 89, 79], key: 'Num 7', sound: '%.70' },
  { keycodes: [104, 91, 80], key: 'Num 8', sound: '%.72' },
  { keycodes: [105, 92, 81], key: 'Num 9', sound: '%.74' },
  // Media Keys
